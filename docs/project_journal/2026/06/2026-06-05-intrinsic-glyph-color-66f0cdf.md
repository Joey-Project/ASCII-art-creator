...
- Intrinsic-color sampling runs only after missing-glyph and fallback filtering accept a candidate, so unsupported glyphs avoid the probe path.
...
- Unit coverage: 10 files / 62 tests passed
